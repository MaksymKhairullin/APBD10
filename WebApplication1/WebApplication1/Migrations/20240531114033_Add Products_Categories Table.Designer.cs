...
namespace WebApplication1.Migrations
{
    ...
    [Migration("20240531114033_Add Products_Categories Table")]
            ...
            modelBuilder.Entity("WebApplication1.Models.ProductsCategories", b =>
                {
                    ...
                    b.Property<int>("CategoryIdCategories")
                        .HasColumnType("int");

                    b.HasKey("IdProduct", "IdCategory");

                    b.HasIndex("CategoryIdCategories");
            ...
            modelBuilder.Entity("WebApplication1.Models.ProductsCategories", b =>
                {
                    b.HasOne("WebApplication1.Models.Categories", "Category")
                        ...
                        .HasForeignKey("CategoryIdCategories")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
